...
//============================================================================= 
SYSTEM_EXTERN unsigned char  volatile  xdata bt_queue_buf[PROTOCOL_HEAD + BT_UART_QUEUE_LMT];  //串口队列缓存
SYSTEM_EXTERN unsigned char xdata  bt_uart_rx_buf[PROTOCOL_HEAD + BT_UART_RECV_BUF_LMT];         //串口接收缓存
SYSTEM_EXTERN unsigned char  xdata bt_uart_tx_buf[PROTOCOL_HEAD + BT_UART_SEND_BUF_LMT];        //串口发送缓存
//
...
SYSTEM_EXTERN unsigned char xdata reset_bt_flag;                                                  //重置bt标志(TRUE:成功/FALSE:失败)
SYSTEM_EXTERN unsigned char xdata set_btmode_flag;                                                //设置bluetooth工作模式标志(TRUE:成功/FALSE:失败)
SYSTEM_EXTERN unsigned char xdata bt_work_state;                                                  //bt模块当前工作状态
#endif
